...
var keenSliderPrevious = document.getElementById("keen-slider-previous");
var keenSliderNext = document.getElementById("keen-slider-next");
var keenSliderPreviousDesktop = document.getElementById("keen-slider-previous-desktop");
var keenSliderNextDesktop = document.getElementById("keen-slider-next-desktop");
...
function showNextTestimonial() {
  testimonialItems[currentIndex].classList.remove("opacity-100");
  testimonialItems[currentIndex].classList.add("opacity-0");
  currentIndex = (currentIndex + 1) % totalTestimonials;
  testimonialItems[currentIndex].classList.remove("opacity-0");
  testimonialItems[currentIndex].classList.add("opacity-100");
}
setInterval(showNextTestimonial, 3e3);
